...
exports.run = (client, message, args) => { 
  ...
  if(message.channel.type !== "text") return;
    ...
    moldura = Jimp.read("https://cdn.discordapp.com/attachments/591513631515082784/608078325918728221/gs.png");
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['receptayyip', 'recep','receptayyiperdogan'],
  permLevel: 0
};

exports.help = {
  name: 'receptayyip',
  description: 'receptayyip',
  usage: 'receptayyip'
};
